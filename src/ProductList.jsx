...
function ProductList({ onHomeClick }) {
    ...
    var totalProduct = useSelector(state => state.cart.items); // total product to cart

    var arraProduct = totalProduct.map((item) => item.name);
    ...
    const totalProductCart = () => {
        ...
        let total = 0
        for (let index = 0; index < totalProduct.length; index++) {

            total += totalProduct[index].quantity
                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Floréva</h3>
                                <i style={{ color: 'white' }}>Todo sobre plantas</i>
                            </div>
                        </a>
                    </div>
                            ...
                            <div className="product-list"> {/* Container for the list of plant cards */}
                                {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                    <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                        ...
                                        {arraProduct.includes(plant.name) ?
                                            
                                                <button
                                                    style={{ backgroundColor: '#eeeeee',color:'#212121' }}
